...
sudo pacman -S --noconfirm --needed zathura zathura-djvu zathura-pdf-mupdf zathura-cb
sudo pacman -S --noconfirm --needed mupdf mupdf-tools
...
##sudo pacman -S --noconfirm --needed sane    ##scaning interface
